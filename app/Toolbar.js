...
example.Toolbar = Class.extend({
	...
	init:function(elementId, view)
	{
		...
		//
		this.undoButton  = $("<button class='gray'>뒤로 가기</button>");
		...
		//
		this.redoButton  = $("<button class='gray'>앞으로 가기</button>");
		...
		//
		this.deleteButton  = $("<button class='gray'>삭제</button>");
        ...
        this.html.append($("<div id='toolbar_hint'>환경 설정 메뉴</div>"));
		this.html.append($("<button id='imageSave'>이미지 저장</button>"));
    },
